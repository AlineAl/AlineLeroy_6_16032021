Voici les instructions à suivre afin de pouvoir accéder à ce projet. Les routes, les models, les controllers et middleware pour le backend ont été classé dans le dossier "api".
